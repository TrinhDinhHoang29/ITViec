  ...
  return (
    <div className="d-sm-block d-block d-lg-flex  gap-3">
      ...
      <Dropdown style={{lineHeight:"50px",width:"500px"}} className="dropdownSearch-toggle-custom">
        <Dropdown.Toggle
          variant="light"
          className="d-flex align-items-center px-3 justify-content-between fs-6"
          bsPrefix="toggle"
        ...
        <Dropdown.Menu style={{width:"100%"}} className="fs-6">
      ...
      {/* Nút tìm kiếm */}
      <Button  style={{padding:"0px 90px"}} variant="danger" className="d-none d-sm-none d-lg-flex align-items-center" onClick={()=>value({type:typeSearch,value:searchValue})}>
